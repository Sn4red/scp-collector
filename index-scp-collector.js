...
// * This also requires to enable Server Members Intent in the Discord Developer
// * Portal.
...
module.exports = { cooldowns: client.cooldowns };
...
const eventFiles = fs
	.readdirSync(eventsPath).filter(file => file.endsWith('.js'));
